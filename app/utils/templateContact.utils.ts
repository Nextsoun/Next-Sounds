export const templateContact = `<!DOCTYPE html>
<html
  lang="en"
                                  ...
                                  <td style="font-size: 0; height: 18px; vertical-align: middle; width: 18px">
                                    <a href="#" target="_blank" style="color: #ea4a40; text-decoration: none">
                                      <img
                                        alt="twitter-logo"
                                        height="18"
                                        src="../../../images/social/black/twitter-logo-transparent-black.png"
                                  ...
                                  <td style="font-size: 0; height: 18px; vertical-align: middle; width: 18px">
                                    <a href="#" target="_blank" style="color: #ea4a40; text-decoration: none">
                                      <img
                                        alt="facebook-logo"
                                        height="18"
                                        src="../../../images/social/black/facebook-logo-transparent-black.png"
                                        style="border-radius: 3px; display: block"
                                        width="18"
                                      />
                                    </a>
                                  ...
                                  <td style="font-size: 0; height: 18px; vertical-align: middle; width: 18px">
                                    <a href="#" target="_blank" style="color: #ea4a40; text-decoration: none">
                                      <img
                                        alt="instagram-logo"
                                        height="18"
                                        src="../../../images/social/black/instagram-logo-transparent-black.png"
                                        style="border-radius: 3px; display: block"
                                        width="18"
                                      />
                                    </a>
                                  ...
                                  <td style="font-size: 0; height: 18px; vertical-align: middle; width: 18px">
                                    <a href="#" target="_blank" style="color: #ea4a40; text-decoration: none">
                                      <img
                                        alt="instagram-logo"
                                        height="18"
                                        src="../../../images/social/black/linkedin-logo-transparent-black.png"
                                        style="border-radius: 3px; display: block"
                                        width="18"
                                      />
                                    </a>
                            ...
                            <tr>
                              <td style="width: 250px">
                                <img
                                  alt="welcome image"
                                  height="auto"
                                  src="https://res.cloudinary.com/dtew73vzx/image/upload/v1719801951/ttbchh6mxdbu0alzy3g2.png"
                                  style="
                                    border: 0;
                                    display: block;
                                    outline: none;
                              ...
                              <tr>
                                <td align="left" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                                  ...
                                  >
                                    ...
                                    <p>Hemos recibido tu solicitud de contacto y queremos agradecerte por tomarte el tiempo para comunicarte con nosotros. Valoramos mucho tu interés y nos comprometemos a responder a tus consultas lo más pronto posible.
                                    </p>
                                  ...
                                  >
                                    <tr valign="top">
                                      <td width="60%" style="font-size: 16px; line-height: 20px; word-break: normal">
                                        ...
                                        <p style="margin: 0; color: #aca9bb; padding-bottom: 10px">{{contactEmail}}</p>
                                      </td> -->
                                      <!-- <td
                                        align="right"
                                        style="
                                      ...
                                      <td
                                        ...
                                        "
                                      >
                                        <p style="margin: 0">$24.95</p>
                                      </td> -->
                                    <!-- </tr>
                                    <tr valign="top">
                                      <td width="60%" style="font-size: 16px; line-height: 20px; word-break: normal">
                                        <p style="margin: 0">Teléfono:</p>
                                        <p style="margin: 0; color: #aca9bb; padding-bottom: 10px">{{contactPhone}}</p>
                                      </td> -->
                                      <!-- <td
                                        align="right"
                                        style="
                                    ...
                                    <tr>
                                      ...
                                      <td align="right" style="font-size: 16px; line-height: 20px; word-break: normal">
                                        <p style="margin: 0"><small>$3.51</small></p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td
          ...
          <![endif]-->
                          ...
                          > -->
                            ...
                            >
                              ...
                              //       <a href="#" style="color: #ea4a40; text-decoration: none"> hello@codedmails.com </a>
                              //     </div>
                              //   </td>
                              // </tr>
                            </table> -->
                            ...
                            >
                              <tr>
                                <td style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                                  <p
                                    style="border-top: solid 1px #f4f4f4; font-size: 1px; margin: 0px auto; width: 100%"
                                  ></p>
                                  <!--[if mso | IE]>
                                    <table
                                      align="center"
                              ...
                              <!-- <tr>
                                <td align="center" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                                  <div
                                    ...
                                    "
                                  >
                                    <a class="footer-link" href="#" style="text-decoration: none; color: #000"
                                      >Support</a
                                    >
                                    &nbsp; | &nbsp;
                                    <a class="footer-link" href="#" style="text-decoration: none; color: #000"
                              ...
                              <tr>
                                <td align="center" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                                  <div
                                    ...
                                    "
                                  >
                                    123 Medalling Jr., Suite 100, Parrot Park, CA 12345<br />
                                    © 2024 Next Sounds Inc.
                                  </div>
                                </td>
                              </tr>
                              <!-- <tr>
                                <td align="center" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                                  ...
                                  >
                                    Update your
                                    <a href="https://google.com" style="color: #ea4a40; text-decoration: none"
                                      >email preferences</a
                                    >
                                    to choose the types of emails you receive, or you can
                                    <a href="https://google.com" style="color: #ea4a40; text-decoration: none">
                                      unsubscribe </a
                                      ...
                                      <tr>
                                        <td style="width: 50px">
                                          <img
                                            alt="image description"
                                            height="auto"
                                            src="../../../images/logo-circle-gray.png"
                                            style="
                                              border: 0;
                                              display: block;
                                              outline: none;
